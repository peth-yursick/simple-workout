import { MuscleGroupVolume } from '@/lib/utils/statsCalculations'
...
export function MuscleBalance({ data }: MuscleBalanceProps) {
  ...
  return (
    <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
      <h3 className="text-sm font-medium text-gray-300 mb-4">Muscle Group Balance</h3>
          ...
          <div key={item.muscle}>
            <div className="flex items-center justify-between mb-1">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-gray-500">{formatVolume(item.volume)}</span>
